...
class FanQie:
    ...
    def direct(self, book_id: str) -> list[str] | str:
        ...
        return direc_list_info['data']['item_list'] if 'item_list' in direc_list_info['data'].keys() else '未配置cookie或者cookie失效'
    ...
    def content(self, item_id: str):
        ...
        # 返回章节正文内容
        # return content_info['data']['content'] if 'content' in content_info['data'].keys() else '未配置cookie或者cookie失效'
